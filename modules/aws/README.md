...
| <a name="input_kernel_update_enabled"></a> [kernel\_update\_enabled](#input\_kernel\_update\_enabled) | Enable the automatic kernel update after the CVM is created | `bool` | `false` | no |
